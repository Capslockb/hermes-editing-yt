        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Everything you need to edit video entirely from text. No timeline,
              no dragging, no cloud.
            </p>
          </div>
          {/* Items */}
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Near-perfect accuracy on Ryzen/RTX. Fast enough for iterative
                editing.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                Configurable gap threshold. Cut at sentence boundaries, not
                mid-word.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                Parse existing subtitles or generate new ones. Edit timing with
                precision.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                13 FastMCP 3.0.2 tools: mark, cut, edit, pipeline. Integrates
                with any Hermes agent.
              </p>
            </article>
            <article>
              <svg
