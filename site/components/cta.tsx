...
export default function Cta() {
  return (
    <section className="relative overflow-hidden" id="install">
      <div
      ...
      <div className="max-w6xl mx-auto px-4 sm:px-6">
        <div className="bg-linear-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              <pre className="overflow-x-auto rounded-xl bg-gray-950 p-4 text-left text-sm text-indigo-200/80">
                <code>{`bash <(curl -sSL https://raw.githubusercontent.com/Capslockb/hermes-editing-yt/main/installer/install.sh)`}</code>
              </pre>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <a
                className="btn relative w-full bg-linear-to-b from-gray-700 to-gray-700 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_--theme(--color-white/.16)] hover:bg-[length:100%_150%] sm:w-auto"
