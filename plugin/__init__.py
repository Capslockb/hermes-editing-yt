"""hermes-editing-yt — Hermes MCP plugin entry point.
...
process entry point and is started by `hermes mcp add hermes-editing-yt` or by
the installer.
...
"""
from . import hermes_editing_yt as _lib
